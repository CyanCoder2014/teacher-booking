...
//        return true;
    ...
    public static function ACL($method):bool{
        return true;
    }
...
//                            return static::$crud[$key1]['values'][$this->attributes[$key]];
//                        else{
//                            $model= explode(',',static::$crud[$key1]['values']);
//                            $model_name =$model[0];
//                            $model_key =$model[1];
//                            $model_value =$model[2];
//                            return $model_name::where($model_key,$this->attributes[$key])->first();
//                        }
//
//                }
//
...
//            }
////            switch (static::$crud[$key1]['type']){
////                case 'datetime': return Jalalian::forge($this->attributes[$key])->format('Y/m/d   H:i:s');break;
////                case 'date': return CalendarUtils::strftime('Y/m/d', strtotime($this->attributes[$key]));break;
//////                case 'select':
//////                    if(is_array(static::$crud[$key1]['values']))
//////                        return static::$crud[$key1]['values'][$this->attributes[$key]];
//////                    else{
...
//////                        $model_key =$model[1];
//////                        $model_value =$model[2];
//////                        return $model_name::where($model_key,$this->attributes[$key])->first()->{$model_value};
//////                    }
////
////                default:return $this->attributes[$key];
////            }
//
//        }
//    }
...
//        $key1 = array_search($key, array_column(static::$crud, 'name'));
//        switch (static::$crud[$key1]['type']){
//            case 'datetime':$this->attributes[$key] = Jalalian::toGeorgian($value); break;
//            case 'date':$this->attributes[$key] = Jalalian::toGeorgianDate($value); break;
//
