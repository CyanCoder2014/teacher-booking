...
class AdminCRUDController extends Controller
{
    ...
    {
        return view('admin.crud.index',['class' => $class]);
    }
    ...
    public function create($class)
    {
        ...
        return view('admin.crud.create',['class' => $class]);
    }
...
//        dd($new);
    ...
    public function show($id,$class)
    {
        ...
        return view('admin.event.single',compact('content'));
    }
    ...
    public function edit($id,$class)
    {
        ...
        if(!$class::ACL('edit',$record))
            return view('error.404');
//        dd($record);
        return view('admin.crud.edit',['class' => $class,'record'=>$record]);
    }
