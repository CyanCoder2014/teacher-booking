...
//
                        'about_us' => ['type'=>'textarea','label'=>'About us','class'=>'ckeditor','style'=>null,'values' => array()],
        ...
        'banner' => [
            ...
            'image' => ['type'=>'file','label'=>'Image','class'=>null,'style'=>null,'values' => array()],
             'description' => ['type'=>'text','label'=>' Intro','class'=>null,'style'=>null,'values' => array()],
        ...
        'contact' => [
            ...
            'address' => ['type'=>'text','label'=>'Address','class'=>null,'style'=>null,'values' => array()],
...
//
                        'image' => ['type'=>'file','label'=>'Image','class'=>null,'style'=>null,'values' => array()],
                        'description' => ['type'=>'text','label'=>' Intro ','class'=>null,'style'=>null,'values' => array()],
                        'description_fa' => ['type'=>'text','label'=>'sweden Intro','class'=>null,'style'=>null,'values' => array()],
                        'link' => ['type'=>'text','label'=>'link','class'=>null,'style'=>null,'values' => array()],
        ],


        'footer_title' => [
                        'title_1' => ['type'=>'text','label'=>'Footer 1  ','class'=>null,'style'=>null,'values' => array()],
                        'title_1_sw' => ['type'=>'text','label'=>'Footer 1 sweden ','class'=>null,'style'=>null,'values' => array()],
                        'title_2' => ['type'=>'text','label'=>'Footer 2  ','class'=>null,'style'=>null,'values' => array()],
                        'title_2_sw' => ['type'=>'text','label'=>'Footer 2 sweden ','class'=>null,'style'=>null,'values' => array()],

        ],
        'footer_1' =>   [  'title' => ['type'=>'text','label'=>'title','class'=>null,'style'=>null,'values' => array()],
                        'title_fa' => ['type'=>'text','label'=>'title sweden','class'=>null,'style'=>null,'values' => array()],
    ...
    'title_sw' => ['type'=>'text','label'=>'Title sweden','class'=>null,'style'=>null,'values' => array()],
//
    'lable_fa' => ['type'=>'text','label'=>'label','class'=>null,'style'=>null,'values' => array()],
    'lable' => ['type'=>'text','label'=>'label sweden ','class'=>null,'style'=>null,'values' => array()],
//
    'about_us' => ['type'=>'textarea','label'=>'  about us','class'=>'ckeditor','style'=>null,'values' => array()],
    'about_us_fa' => ['type'=>'text','label'=>'about us   sweden ','class'=>null,'style'=>null,'values' => array()],
]
